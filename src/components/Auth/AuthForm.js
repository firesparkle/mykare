...
const AuthForm = () => {
  ...
  const submitHandler = (event) => {
    ...
    if (!formIsValid) {       //checking form validity
    ...
    if (isLogin) {      
      ...
      if(founduser&&founduser.email==enteredEmail&&founduser.password==enteredPassword &&enteredEmail == "admin@gmail.com" ){
        authCtx.loginStateHandler(true);
        localStorage.setItem('admin',true);
        history.replace('/admin');
      }
      else if(founduser&&founduser.email==enteredEmail&&founduser.password==enteredPassword){
